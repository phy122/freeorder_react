...
-- CARTS (주문 대기)
INSERT INTO CARTS (ID, PRODUCTS_ID, AMOUNT, PRICE, CREATED_AT, UPDATED_AT)
VALUES
('1', '1', 2, 16000, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('2', '3', 1, 12000, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
-- CATEGORIES (카테고리)
INSERT INTO CATEGORIES (ID, CODE, NAME, SEQ, CREATED_AT, UPDATED_AT)
VALUES
('1', 'SOUP', '찌개류', 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('2', 'GRILL', '구이류', 2, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
-- OPTION_ITEMS (옵션 항목)
INSERT INTO OPTION_ITEMS (ID, OPTION_ID, NAME, QUANTITY, PRICE, SEQ, CREATED_AT, UPDATED_AT)
VALUES
('1', '1', '공기밥', 50, 1000, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
